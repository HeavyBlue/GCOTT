...
def listen(ip, port):
    ...
    print("Listening...")
    target_, target_address = target_connection_.accept()
    target_ip, target_port = target_address
